...
#celery settings
CELERY_BROOKER_URL ='redis://localhost:6379/0'
CELRY_RESULT_BACKEND = 'redis://localhost:6379/0'
...
SWAGGER_SETTINGS = {
    ...
    "DEFAULT_INFO":"bank_system.urls.schema_view",
